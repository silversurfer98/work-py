# 'Check list_HAIFA_H10-GD-B-86101.xlsx',
...
filename=['Check list_HAIFA_H10-GD-B-86145.xlsx',
...
for x in filename:
    ...
    if(rootch==1):
        ...
        print(sheet1["G21"].value)

        if(sheet1["G21"].value=="N/A"):
            sheet1["G21"]="X"
            sheet1["H21"]=""
        
        if(sheet1["G25"].value=="N/A"):
        ...
        sheet4["H24"]=""
        print("PSV --> ",sheet4["G19"].value)
        if(sheet4["G19"].value!="N/A"):
            psvc=int(input("does psv on hold clear: "))
            if(psvc==1):
                sheet4["G19"]="X"
                sheet4["H19"]=""

        if(sheet4["G8"].value=="X"):
            cvbp = int(input("is cv on hold : "))
            if(cvbp==1):
                sheet4["G10"]="ON HOLD"
                sheet4["H10"]=""
                sheet4["G11"]="N/A"
